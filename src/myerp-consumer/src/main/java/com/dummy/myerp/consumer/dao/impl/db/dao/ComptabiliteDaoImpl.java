...
public class ComptabiliteDaoImpl extends AbstractDbConsumer implements ComptabiliteDao {
    ...
    @Override
    public EcritureComptable updateEcritureComptable(EcritureComptable pEcritureComptable) {
        // ===== Ecriture Comptable
        NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
        MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
    ...
    private static String SQLgetSequenceByCodeJournalAndByAnneeCourante;
    public void setSQLgetSequenceByCodeJournalAndByAnneeCourante(String pSQLgetSequenceByCodeAndAnneeCourante) {
        SQLgetSequenceByCodeJournalAndByAnneeCourante = pSQLgetSequenceByCodeAndAnneeCourante;
    }
    /**
     ...
     */
    @Override
    public SequenceEcritureComptable getSequenceByCodeJournalAndByAnneeCourante(SequenceEcritureComptable pSequence) throws NotFoundException {
        NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
        ...
        try {
            return vJdbcTemplate.queryForObject(SQLgetSequenceByCodeJournalAndByAnneeCourante, vSqlParams, vRM);
    ...
    public void setSQLinsertOrUpdateSequenceEcritureComptable(String pSQLupsertSequenceEcritureComptable) {
        SQLinsertOrUpdateSequenceEcritureComptable = pSQLupsertSequenceEcritureComptable;
    }
    /**
